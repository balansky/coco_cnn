...
class ImageDecoder(object):
    ...
    def decode_and_resize(self, raw_image):
    ...
    def batch_decode_tfrecords(self, tfrecord, tfrecord_files, batch_size, num_epochs=1, capacity=60,
        ...
        image = self.decode_and_resize(image_feature['image_raw'])
